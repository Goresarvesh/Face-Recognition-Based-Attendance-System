...
def add():
    if request.method == 'POST':
        ...
        if user_exists(newusername, newuserid):
            message = f"User '{newusername}' with ID '{newuserid}' already exists."
...
def user_exists(username, userid):
    userimagefolder = 'static/faces/' + username + '_' + str(userid)
    return os.path.isdir(userimagefolder)
